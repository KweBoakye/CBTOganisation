...
class MonthCalendarOuterRecyclerAdapter(val monthCalendarListener: MonthCalendarListener): ListAdapter<YearMonth, MonthCalendarOuterRecyclerAdapter.MonthCalendarOuterViewHolder>(YearMonthDiffUtil()) {
    ...
    val months: MutableList<YearMonth> = MutableList(24){  (YearMonth.of(2019,1).plusMonths(it.toLong()))}
    ...
    class MonthCalendarOuterViewHolder(layoutToInflate: View) : RecyclerView.ViewHolder(layoutToInflate) {
        ...
        fun bind(position: Int,months: MutableList<YearMonth> , childAdapter: MonthCalendarRecyclerAdapter,
                 viewPool : RecyclerView.RecycledViewPool, listofMonthDays:MutableList<MutableList<LocalDate>>, childTaskNamesLists: MutableList<MutableList<String>>){
    ...
    override fun onCreateViewHolder(
        ...
        val monthCalendarOuterViewHolder =
            MonthCalendarOuterViewHolder(
                monthCalendarFrameBinding.root
            )
        ...
        monthCalendarOuterViewHolder.monthCalendarRecyclerView.setRecycledViewPool(viewPool)
        val childLayoutManager = CustomGridLayoutManager(parent.context, 7, GridLayoutManager.VERTICAL, false)
        childLayoutManager.initialPrefetchItemCount = 42
        monthCalendarOuterViewHolder.monthCalendarRecyclerView.layoutManager = childLayoutManager
        monthCalendarOuterViewHolder.monthCalendarRecyclerView.setHasFixedSize(true)
    ...
    override fun onBindViewHolder(holder: MonthCalendarOuterViewHolder, position: Int) {
        ...
        holder.bind(position, months, childAdapter, viewPool, listofMonthDays, childTaskNamesLists)
